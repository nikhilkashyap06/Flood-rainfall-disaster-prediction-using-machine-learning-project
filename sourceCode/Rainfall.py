...
def rainfall(year,region):
    data = pd.read_csv('C:\\Users\\LENOVO\\Desktop\\Flood-Rainfall-Disaster-Prediction-Website-master\\sourceCode\\data\\Sub_Division_IMD_2017.csv')
    ...
    #     autolabel(rects2)
        ...
        plt.savefig('C:\\Users\\LENOVO\\Desktop\\Flood-Rainfall-Disaster-Prediction-Website-master\\sourceCode\\static\\img\\rainfall.png')
    ...
    def prediction2(year,region):
        ...
        plot_graphs(Y_testing,y_pred,'  Region: '+str(region))
        return mae,score
