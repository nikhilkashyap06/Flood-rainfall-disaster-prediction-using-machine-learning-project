...
def alerting():
    data1=pd.read_csv('C:\\Users\\LENOVO\\Desktop\\Flood-Rainfall-Disaster-Prediction-Website-master\\sourceCode\\data\\forecast\\forecasted_level_of_rivers.csv')
    res=[]
...
def water_level_predictior():
    ...
    y_pred.to_csv('C:\\Users\\LENOVO\\Desktop\\Flood-Rainfall-Disaster-Prediction-Website-master\\sourceCode\\data\\forecast\\forecasted_level_of_rivers.csv',index=False)
    return
