...
def daily_runoff_forecast(filename,wtd):
	...
	df2_prophet.fit(df2)
	path='C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/trained/'+filename+'_daily_runoff_prophet'
	...
	df4.to_csv('C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/data/forecast/'+filename+'_daily_runoff_forecast.csv',index=False)
