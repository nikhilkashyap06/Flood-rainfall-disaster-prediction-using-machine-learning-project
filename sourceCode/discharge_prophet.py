...
def discharge_forecast(filename,wtd):
	# Import raw data
	def import_data():
	    raw_data_df = pd.read_excel('C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/data/'+filename+'.xlsx', header=0) # creates a Pandas data frame for input value
	    return raw_data_df
	...
	monthly.plot(style=[':', '--', '-'],title='Monthlysdhfbhdkbgfhdgfuydsgfuyegvfcugf Trends')
	# In[10]:
	...
	df2_prophet.fit(df2)
	path='C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/trained/'+filename+'_discharge_prophet'
	...
	df4.to_csv('C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/data/forecast'+filename+'_discharge_forecast.csv',index=False)
