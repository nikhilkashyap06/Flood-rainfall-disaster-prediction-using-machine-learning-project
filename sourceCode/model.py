...
def flood_classifier(filename,fd,validating=0):
	...
	data1=pd.read_excel('C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/data/'+filename+'.xlsx')
	...
	# data1['Date'] = data1['Date'] + pd.Timedelta(days=8)
	...
	extended_years = pd.date_range(start=yearly.index.min(), end='2025-12-31', freq='Y')
	yearly = yearly.reindex(extended_years, fill_value=0)   
	...
	plt.savefig('C:\\Users\\LENOVO\\Desktop\\Flood-Rainfall-Disaster-Prediction-Website-master\\sourceCode\\static\\img\\flood.png')
	#--------------------------------
	...
	path='C:/Users/LENOVO/Desktop/Flood-Rainfall-Disaster-Prediction-Website-master/sourceCode/trained/'+filename+'_LDA'
